function [integral] = divideAndConquer_integrate_recurrent(f, ...
...
elseif randPoints < 4 * n_var_est + 10
    ...
    i2 = divideAndConquer_integrate_recurrent(f, randPoints2, ...
        n_var_est, a+(b-a)/2, b, c, d-(d-c)/2, oldEstimate2);
    i3 = divideAndConquer_integrate_recurrent(f, randPoints3, ...
        n_var_est, a, b-(b-a)/2, c+(d-c)/2, d, oldEstimate3);
    i4 = divideAndConquer_integrate_recurrent(f, randPoints4, ...
        n_var_est, a+(b-a)/2, b, c+(d-c)/2, d, oldEstimate4);
